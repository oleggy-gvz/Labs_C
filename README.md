...
**Лабораторная работа №1-1 «Управляющие структуры и циклы» (Lab\_1-1)**
=
...
**Лабораторная работа №1-2 «Итерационные процессы» (Lab\_1-2)**
=
...
**Лабораторная работа №1-3 «Строки» (Lab\_1-3)**
=
...
**Лабораторная работа №1-4 «Сортировки» (Lab\_1-4)**
...
**Лабораторная работа №2-1 «Сортировка и поиск с указателями» (Lab\_2-1)**
=
...
**Лабораторная работа №2-2 «БД на структурах» (Lab\_2-2)**
=
...
**Лабораторная работа №2-3 «Работа с памятью через указатели» (Lab\_2-3)**
=
...
**Лабораторная работа №2-4 «Функции с переменным числом параметров» (Lab\_2-4)**
=
...
**Лабораторная работа №2-5 «Собственная реализация функций malloc и free» (Lab\_2-5)**
=
